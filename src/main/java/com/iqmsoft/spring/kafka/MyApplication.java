package com.iqmsoft.spring.kafka;
...
public class MyApplication {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < 30; i++) {
        	GenericMessage<?> g = new GenericMessage<>("test " + i);
        	System.out.println("Sending To Kafka " + g);
            toKafka.send(g);
        }
        ...
        while (received != null) {
            System.out.println("Kafka Received " + received);
